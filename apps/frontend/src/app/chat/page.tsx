...
export default function ChatPage() {
  ...
  const generateResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes("homologação") || lowerMessage.includes("prodist")) {
  ...
  const quickActions = [
    { label: "Dimensionar Sistema", icon: <Zap className="h-4 w-4" />, message: "Preciso dimensionar um sistema fotovoltaico" },
    { label: "Comparar Painéis", icon: <Sun className="h-4 w-4" />, message: "Quais painéis solares vocês recomendam?" },
    { label: "Sistema com Bateria", icon: <Battery className="h-4 w-4" />, message: "Quero um sistema com bateria" },
    { label: "Homologação", icon: <Settings className="h-4 w-4" />, message: "Como funciona a homologação?" },
  ];
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-muted-foreground">
          Tire suas dúvidas sobre energia solar e receba recomendações personalizadas
        </p>
      </div>

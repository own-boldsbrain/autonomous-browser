...
export function GradientIcon({
  ...
  const iconSvgPaths: Record<string, string> = {
    sparkles: "m9 12 2 2 4-4M21 12c-1 0-3-1-3-3s2-3 3-3 3 1 3 3-2 3-3 3M3 5c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2ZM5 21c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2ZM12 3c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2Z",
    rocket: "M4.5 16.5c-1.5 1.5-3 3-3 3s1.5-1.5 3-3M10.5 10.5 21 0l-10.5 10.5M13.5 13.5 24 3l-10.5 10.5M4.5 16.5 16.5 4.5",

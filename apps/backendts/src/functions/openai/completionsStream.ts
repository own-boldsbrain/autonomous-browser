...
} from "@restackio/integrations-openai/utils";
...
import { streamEvent as broadcastEvent } from "../stream/broadcast";
export async function openaiChatCompletionsStream({
  ...
  const readableStream =
    streamEnd.toReadableStream() as unknown as ReadableStream<any>;
